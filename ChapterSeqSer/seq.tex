...
\item ...fractions whose numerators are all even natural numbers starting from zero and whose denominators are all odd natural numbers starting from 1. $$\frac{0}{1},\frac{2}{3},\frac{4}{5},\frac{6}{7},\ldots$$
    \solushun{$$a_0=\frac{0}{1}, a_n=\frac{1}{n^2+n}+a_{n-1}.$$ This is obtained by calculating the difference $a_n-a_{n-1}$ and then rearranging the equatin to solve for $a_n$\\.}{.3in}
\end{itemize}
\end{exercise}
\section{Factorials}
