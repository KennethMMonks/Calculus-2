    ...
    \item Using the geometric series formula, we get 
        \begin{align*}
            A_N&=\frac{1-\frac{-1}{2}^{N+1}}{1-\frac{-1}{2}}\\
               &=\frac{1-\frac{-1}{2}^{N+1}}{\frac{3}{2}}\\
               &=\frac{2}{3}\left(1-\frac{-1}{2}^{N+1}\right)\\
               &=\left(\frac{2}{3}-\frac{2}{3}\frac{-1}{2}^{N+1}\right)\\
               &=\left(\frac{2}{3}-\frac{2}{3}\frac{-1}{2}^{N+1}\right)\\
               &=\left(\frac{2}{3}-\frac{-1^{N+1}}{3\cdot2^{N}}\right)\\
        \end{align*}

    \item The sequence of partial sums does converge, again, because we have a geometric series with $|r|<1$. The limit is $\lim_{N\to\infty}A_N=\frac{2}{3}$.
    \end{itemize}
    }{1.5in}
\item The sequence defined by $$ a_n=\left(-1\right)^n$$
    ...
    \item $A_N=\frac{1}{2}+\frac{(-1)^N}{2}$.

    \item The sequence of partial sums does not converge.
    \end{itemize}
    }{1.5in}
...
\solushun{
        ...
        \begin{tabular}{|c|c|c|} \hline
            ...
            1 & -1 & $2$ \\
            2 & $\frac{1}{3}$ & $\frac{7}{3}$ \\
            3 & $\frac{-1}{9}$ & $\frac{20}{9}$ \\
            4 & $\frac{1}{27}$ & $\frac{61}{27}$ \\
            \hline
        \end{tabular}
        \end{center}
...
\solushun{
    ...
    \item This is an Arithmetic Series with $a_0=5, d=1$, and $N+1$ number of terms. Thus, by our Arithmetic Series Formula
