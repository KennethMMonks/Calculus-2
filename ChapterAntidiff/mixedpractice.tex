...
\solushun{ Yes, use one factor of $\sin{x} $ for the $\dif u$. Specifically, $u=\cos{x}$ implies $ \dif u=-\sin{x} \dif x$ and use  $\sin^2{x}=1-\cos^2{x}$.  We now calculate the integral as 
$\int {\cos^{13}{x}\sin^{5}{x} dx}=\int {\cos^{13}{x}\sin^{4}{x}\sin{x} \dif x}=
-\int {u^{13}(1-u^2)^2 \dif u}=-\int {u^{13}-2u^{15} + u^{17} \dif u}= -\frac{u^{14}}{14} + \frac{2 u^{16}}{16} + \frac{u^{18}}{18} = -\frac{\cos^{18}{x}}{18}+ \frac{\cos^{16}{x}}{8} - \frac{\cos^{14}{x}}{14} + C.
$\\ }{0in}
...
%\solushun{ $$ \int {1 + \frac{ -\frac{1}{9}}{x+1} + \frac{\frac{28}{9}}{x-2} + \frac{\frac{8}{3}}{(x-2)^2} dx} = x -\frac{1}{9} \ln{|x+1|} + \frac{28}{9} \ln{|x-2|} - \frac{8}{3} \frac{1}{(x-2)} + C$$}
\end{itemize}
